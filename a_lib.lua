...
function SubTab:AddDropdown(opts)
    ...
    return registerFlag(opts.Flag, "dropdown", {
        Set=function(_,o) value=o; vl.Text=tostring(o); fire(opts.Callback,o) end, Get=function() return value end,
...
function SubTab:AddMultiDropdown(opts)
    ...
    return registerFlag(opts.Flag, "multidropdown", {
        Set=function(_,sel)
            ...
            rebuild(); updateSummary(); fire(opts.Callback,selectedList())
        end,
